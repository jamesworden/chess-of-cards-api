...
public static class SensorBadWordsUtil
{
  public static string ReplaceBadWordsWithAsterisks(this string input)
  {
  ...
  private static readonly Dictionary<string, string> ForeignCharacters =
    new()
    {
      { "äæǽ", "ae" },
      { "öœ", "oe" },
  ...
  private static readonly string[] LowerCaseBadWords =
  {
    "2 girls 1 cup",
    "2g1c",
    "4r5e",
